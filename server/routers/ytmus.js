...
async function ytMusic(URL) {
    ...
    let thumb = await page.$eval('body > div:nth-child(1) > div:nth-child(4) > div > div.col-md-3 > img', (element) => {
    ...
    let LinkAudio = await page.$eval('#download > div > div > a', (element) => {
	...
	browser.close();
    return { thumb, LinkAudio, titleInfo, sizeInfo }
}
